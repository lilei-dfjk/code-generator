...
public class BrowserLauncher {
		...
		case 0:
			try {
				...
				appleEventConstructor = appleEventClass
						.getDeclaredConstructor(new Class[] { Integer.TYPE,
								Integer.TYPE, aeTargetClass, Integer.TYPE,
								Integer.TYPE });
				...
				putParameter = appleEventClass.getDeclaredMethod(
						"putParameter",
						new Class[] { Integer.TYPE, aeDescClass });
	...
	private static Object locateBrowser() {
		...
		case 0:
			try {
				...
				return appleEventConstructor.newInstance(new Object[] {
	...
	public static void openURL(String url) throws IOException {
		...
		case -1:
			process = Runtime.getRuntime().exec(
					new String[] { (String) browser, "-remote",
							"'openURL(" + url + ")'" });
			try {
	...
	private static native int ICLaunchURL(int paramInt1,
			byte[] paramArrayOfByte1, byte[] paramArrayOfByte2, int paramInt2,
			int[] paramArrayOfInt1, int[] paramArrayOfInt2);
}
